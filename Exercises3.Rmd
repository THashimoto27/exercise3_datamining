...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
dengue <- read.csv("/Users/arindamchatterjee/Documents/GitHub/ECO395M/data/dengue.csv")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
# read in data
greenbuildings <- read.csv("/Users/arindamchatterjee/Documents/GitHub/ECO395M/data/greenbuildings.csv")
